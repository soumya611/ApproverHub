...
import type { CampaignRowData, StatusCategory } from "@/data/campaigns";
...
export default function CreateCampaign() {
  ...
  const handleSaveCampaign = () => {
    ...
    const statusCategory: StatusCategory =
      campaignStatus === "Completed"
        ...
        : campaignStatus === "Start Pending"
          ? "not_started"
          : "in_progress";
    const jobStatusTag: CampaignRowData["jobStatusTag"] = associatedJobs.some(
      (job) => job.tag === "Late"
    )
      ? "Late"
      : null;
    ...
    const payload: Omit<CampaignRowData, "id"> = {
